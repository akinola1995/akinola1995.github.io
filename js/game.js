...
function createScene()
{
        ...
        // create the background sky's material
        var skyMaterial = 
            new THREE.MeshLambertMaterial(
                {
                  color: 0x00FFFF
    ...
    paddle2.castShadow = true;        
        ...
        var curtainPlane1 = new THREE.Mesh(
          ...
          curtainMaterial);
        curtainPlane1.position.y = 230;

        var curtainPlane2 = new THREE.Mesh(
          ...
          curtainMaterial);
        curtainPlane2.position.y = -230;

        curtainPlane1.rotation.x = Math.PI/2;
        curtainPlane2.rotation.x = Math.PI * 1.5;
  
        scene.add(curtainPlane1);
        scene.add(curtainPlane2);
